...
func BuildEIP712DomainSeparator(nameHash [32]byte, versionHash [32]byte, chainID *big.Int, address common.Address) []byte {
	types := []abi.Type{
		Bytes32,
		Bytes32,
		Bytes32,
	...
	return crypto.Keccak256(encodedDomainSeparator)
}
